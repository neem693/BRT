package com.theComments.brt.jpa;
...
@EnableJpaRepositories(
		basePackages = "com.theComments.brt.jpa.theComment.dao",
...
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean userEntityManager() {
		...
		em.setPackagesToScan(new String[] {"com.theComments.brt.jpa.theComment.model"});
