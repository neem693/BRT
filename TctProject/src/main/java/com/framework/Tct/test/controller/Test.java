...
public class Test {
	...
	public Map<String, Object> getGet() {
		// 해당 사항은 Tracing Micro Service Logs
		LOG.log(Level.INFO, "get API is calling@@@@@@@@@@@@@@@@@@@@@@");
	...
	public ResponseEntity<Object> downloadFile(@RequestParam(required = true, name = "fileName") String fileName)
			throws IOException {
