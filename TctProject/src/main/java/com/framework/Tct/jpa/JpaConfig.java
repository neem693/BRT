...
@Configuration
@EnableJpaRepositories(basePackages = "com.framework.Tct.jpa.Jpa1.dao", entityManagerFactoryRef = "userEntityManager", transactionManagerRef = "userTransactionManager")
